...
public final class GenericServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.xy.grpc.core.generic.GenericRequest,
      com.xy.grpc.core.generic.GenericResponse> getCallMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Call",
      requestType = com.xy.grpc.core.generic.GenericRequest.class,
      responseType = com.xy.grpc.core.generic.GenericResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.xy.grpc.core.generic.GenericRequest,
      com.xy.grpc.core.generic.GenericResponse> getCallMethod() {
    io.grpc.MethodDescriptor<com.xy.grpc.core.generic.GenericRequest, com.xy.grpc.core.generic.GenericResponse> getCallMethod;
      ...
      synchronized (GenericServiceGrpc.class) {
        if ((getCallMethod = GenericServiceGrpc.getCallMethod) == null) {
          GenericServiceGrpc.getCallMethod = getCallMethod =
              io.grpc.MethodDescriptor.<com.xy.grpc.core.generic.GenericRequest, com.xy.grpc.core.generic.GenericResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Call"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.xy.grpc.core.generic.GenericRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.xy.grpc.core.generic.GenericResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void call(com.xy.grpc.core.generic.GenericRequest request,
        io.grpc.stub.StreamObserver<com.xy.grpc.core.generic.GenericResponse> responseObserver) {
  ...
  public static final class GenericServiceStub
    ...
    /**
     */
    public void call(com.xy.grpc.core.generic.GenericRequest request,
        io.grpc.stub.StreamObserver<com.xy.grpc.core.generic.GenericResponse> responseObserver) {
  ...
  public static final class GenericServiceBlockingStub
    ...
    /**
     */
    public com.xy.grpc.core.generic.GenericResponse call(com.xy.grpc.core.generic.GenericRequest request) {
  ...
  public static final class GenericServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.xy.grpc.core.generic.GenericResponse> call(
        com.xy.grpc.core.generic.GenericRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CALL:
          serviceImpl.call((com.xy.grpc.core.generic.GenericRequest) request,
              (io.grpc.stub.StreamObserver<com.xy.grpc.core.generic.GenericResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.xy.grpc.core.generic.GenericRequest,
              com.xy.grpc.core.generic.GenericResponse>(
  ...
  private static abstract class GenericServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.xy.grpc.core.generic.GenericProto.getDescriptor();
    }
